...
export const LoginPage = () => {
  ...
  const handleRegisterSubmit = async (event) => {
    ...
    const email = event.target.elements.u_email.value;
    const password = event.target.elements.u_password.value;
  ...
  return (
    <>
      ...
      <div className="w-80 md:w-96 lg:w-[800px] mx-auto mt-[5%] bg-white flex items-center relative overflow-hidden shadow-xl">
        {/* register form  */}
        <form
